...
class Course(models.Model):
    ...
    def total_score(self):
        ...
        for question in self.question_set.all():
           if question.question_score == True:
                total_score += 1
        marks = (total_score/question_count) * 100
        return marks
...
class Question(models.Model):
    ...
    question_score = models.BooleanField()
    ...
    def is_get_score(self, selected_ids):
       ...
       selected_wrong = self.choice_set.filter(choice_correct=False, id__in=selected_ids).count()
